describe("Intermission", function() {
  ...
  it('Find City, State, and Zip code', function() {
    ...
    var fixThisPattern = /[\s]([\w\s.]*)[,]?\s([\w]*)\s([\d-]*)$/;
  ...
  it('Parse URL, detect invalid format', function() {
    ...
    var fixThisPattern = /^(https?|ftp|ssh)(:\/\/)([\w\s.]*)(:[\d]+)?[\/]([\w\/]+\/)?([\w.]*)?([\w?=+]*)?/;

    var protocolGroup  = 1;
    var serverGroup    = 3;
    var portGroup      = 4;
    var directoryGroup = 5;
    var fileGroup      = 6;
    var getParamsGroup = 7;
    ...
    // Debug:
    var protocol1   = matches1.length > protocolGroup  ? (matches1[protocolGroup]  !== undefined ? matches1[protocolGroup]  : "" ) : "";
    var server1     = matches1.length > serverGroup    ? (matches1[serverGroup]    !== undefined ? matches1[serverGroup]    : "" ) : "";
    var port1       = matches1.length > portGroup      ? (matches1[portGroup]      !== undefined ? matches1[portGroup]      : "" ) : "";
    var directory1  = matches1.length > directoryGroup ? (matches1[directoryGroup] !== undefined ? matches1[directoryGroup] : "" ) : "";
    var file1       = matches1.length > fileGroup      ? (matches1[fileGroup]      !== undefined ? matches1[fileGroup]      : "" ) : "";
    var getParams1  = matches1.length > getParamsGroup ? (matches1[getParamsGroup] !== undefined ? matches1[getParamsGroup] : "" ) : "";

    var protocol2   = matches2.length > protocolGroup  ? (matches2[protocolGroup]  !== undefined ? matches2[protocolGroup]  : "" ) : "";
    var server2     = matches2.length > serverGroup    ? (matches2[serverGroup]    !== undefined ? matches2[serverGroup]    : "" ) : "";
    var port2       = matches2.length > portGroup      ? (matches2[portGroup]      !== undefined ? matches2[portGroup]      : "" ) : "";
    var directory2  = matches2.length > directoryGroup ? (matches2[directoryGroup] !== undefined ? matches2[directoryGroup] : "" ) : "";
    var file2       = matches2.length > fileGroup      ? (matches2[fileGroup]      !== undefined ? matches2[fileGroup]      : "" ) : "";
    var getParams2  = matches2.length > getParamsGroup ? (matches2[getParamsGroup] !== undefined ? matches2[getParamsGroup] : "" ) : "";

    var protocol3   = matches3.length > protocolGroup  ? (matches3[protocolGroup]  !== undefined ? matches3[protocolGroup]  : "" ) : "";
    var server3     = matches3.length > serverGroup    ? (matches3[serverGroup]    !== undefined ? matches3[serverGroup]    : "" ) : "";
    var port3       = matches3.length > portGroup      ? (matches3[portGroup]      !== undefined ? matches3[portGroup]      : "" ) : "";
    var directory3  = matches3.length > directoryGroup ? (matches3[directoryGroup] !== undefined ? matches3[directoryGroup] : "" ) : "";
    var file3       = matches3.length > fileGroup      ? (matches3[fileGroup]      !== undefined ? matches3[fileGroup]      : "" ) : "";
    var getParams3  = matches3.length > getParamsGroup ? (matches3[getParamsGroup] !== undefined ? matches3[getParamsGroup] : "" ) : "";

    var protocol4   = matches4.length > protocolGroup  ? (matches4[protocolGroup]  !== undefined ? matches4[protocolGroup]  : "" ) : "";
    var server4     = matches4.length > serverGroup    ? (matches4[serverGroup]    !== undefined ? matches4[serverGroup]    : "" ) : "";
    var port4       = matches4.length > portGroup      ? (matches4[portGroup]      !== undefined ? matches4[portGroup]      : "" ) : "";
    var directory4  = matches4.length > directoryGroup ? (matches4[directoryGroup] !== undefined ? matches4[directoryGroup] : "" ) : "";
    var file4       = matches4.length > fileGroup      ? (matches4[fileGroup]      !== undefined ? matches4[fileGroup]      : "" ) : "";
    var getParams4  = matches4.length > getParamsGroup ? (matches4[getParamsGroup] !== undefined ? matches4[getParamsGroup] : "" ) : "";

    var protocol5   = matches5.length > protocolGroup  ? (matches5[protocolGroup]  !== undefined ? matches5[protocolGroup]  : "" ) : "";
    var server5     = matches5.length > serverGroup    ? (matches5[serverGroup]    !== undefined ? matches5[serverGroup]    : "" ) : "";
    var port5       = matches5.length > portGroup      ? (matches5[portGroup]      !== undefined ? matches5[portGroup]      : "" ) : "";
    var directory5  = matches5.length > directoryGroup ? (matches5[directoryGroup] !== undefined ? matches5[directoryGroup] : "" ) : "";
    var file5       = matches5.length > fileGroup      ? (matches5[fileGroup]      !== undefined ? matches5[fileGroup]      : "" ) : "";
    var getParams5  = matches5.length > getParamsGroup ? (matches5[getParamsGroup] !== undefined ? matches5[getParamsGroup] : "" ) : "";
